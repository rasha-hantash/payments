...
INSERT INTO ledger_entries (id, transaction_id, account_id, direction, amount) VALUES 
    ('le_2', 'txn_1',  'acct_2', 'debit', 500),
    ('le_1', 'txn_1',  'acct_1', 'credit', 500),
    ('le_3', 'txn_2',  'acct_1', 'debit', 50),
    ('le_4', 'txn_2', 'acct_2', 'credit', 50);
